...
<header>
        ...
        <div class="header-right">
          <button class="">
            <span><i class="far fa-globe"></i></span> English
      ...
      <main>
        <div class="section-content">
          ...
          <h3>Watch anywhere.Camcel anytime.</h3>
          <p>
            Ready to Watch? Enter your Email to create or restart your
            membership.
          </p>
        </div>
        <div class="section-btn_start">
          <input
            type="text"
            id="search"
            name="search"
...
shows_container.innerHTML = ` <article>
       <div class="card-container">
        ...
        <div class="style-cards ">
         ...
         <div class="style-cards ">
              <div class="card-box">
                  <div class="card-image">
                      <img src="img4.png" alt="Netflix Mobile">
                  </div>
...
const list_box_container = document.querySelector(".list-box-container");
list_box_container.innerHTML = ` <article class="lastsec">
      <div class="faq">
...
footer_container.innerHTML = `<!-- Footer section -->
    <footer>
      <div class="container">
        <div class="first">
          <h3>About</h3>
        ...
        <div class="first">
          <h3>Contact</h3>
          <ul class="content">
            <li><a href="mailto:Knowmore@gmail.com">Knowmore@gmail.com</a></li>
            <li><a href="tel:12345678900">+1 234 567 8900</a></li>
            <li>
              <a href="#"
                >No,28 Kamaraj Street,<br />Murungapakkam,<br />Pondicherry-605004.</a
              >
            </li>
          </ul>
        </div>
    ...
    <div class="copyrightText">
      <p>Copyright © 2021 <span class="copyname">Sangeetha</span>.</p>
    </div>`;
